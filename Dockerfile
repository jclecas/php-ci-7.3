...
RUN \
    ...
    && apt-get install -y \
        ...
        ack-grep bsdmainutils dos2unix gettext git gnupg graphviz jq moreutils nano python python3 python-pip python3-pip shellcheck sshpass \
        python-dev python3-dev libzip-dev unzip zip \
